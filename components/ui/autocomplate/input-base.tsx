  ...
  return (
    ...
    >
      <Primitive.div
        ...
        className={cn(
          'relative flex min-h-12 cursor-text items-center rounded-xl bg-input/30 py-3 pe-4 ps-12 text-base transition duration-300 focus-within:ring-[3px] focus-within:ring-primary/30 hover:shadow',
...
>(({ ...props }, ref) => {
  const { controlRef, autoFocus, disabled } = useInputBaseContext();
...
>(({ className, ...props }, ref) => (
  <Primitive.input
    ref={ref}
    className={cn('w-full flex-1 !outline-0', className)}
    {...props}
  />
));
