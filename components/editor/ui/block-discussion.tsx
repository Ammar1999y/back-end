  ...
  return (
    <div className='flex w-full justify-between'>
      ...
      >
        ...
        <PopoverContent
          align='center'
          className='max-h-[min(50dvh,calc(-24px+var(--radix-popper-available-height)))] w-96 min-w-44 max-w-[calc(100vw-24px)] overflow-y-auto p-0 data-[state=closed]:opacity-0'
        ...
        {totalCount > 0 && (
          <div className='relative left-0 size-0 select-none'>
            <PopoverTrigger asChild>
              <Button
                className='ms-1 mt-1 flex h-6 gap-1 !px-1.5 py-0 text-muted-foreground/80 hover:text-muted-foreground/80 data-[active=true]:bg-muted'
