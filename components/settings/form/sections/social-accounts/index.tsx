import type { SocialAccountItem } from '@/types/settings';
...
import { SocialAccountItemContent } from './item';
...
const DEFAULT_ITEM: Omit<SocialAccountItem, 'id'> = {
  key: '',
  title: '',
  link: '',
  isActive: true,
    ...
    <div className='relative space-y-4'>
      ...
      {fields.length === 0 ? (
        <div className='rounded-lg border-2 border-dashed p-12 text-center'>
          <p>لا توجد حسابات تواصل بعد</p>
          <p className='mt-1 text-sm text-muted-foreground'>
            اضغط على &quot;إضافة حساب&quot; للبدء
          </p>
        </div>
      ) : (
        <SortableList
          ...
          overlay={
            activeItem ? (
              <SocialAccountItemContent showDragHandle index={activeIndex} />
            ) : null
          }
        >
